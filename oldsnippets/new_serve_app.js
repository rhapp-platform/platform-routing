export default {
  async fetch(request) {
    ...
    // FUTURif we have any other sidecars, we treat it as the starting block?
    ...
    // App not found
    if (!disposition) return fetch(`https://${ag}.rhapp.app/dne/index.html`);
...
<body>
    <div class="fixed center middle center-align">
        ...
        <h4 class="center-align bold">App Inactive</h4>
        <h6 class="center-align">https://${ag}.rhapp.app/${an}</h6>
        <div class="tiny-text">Status ${A}</div>
    </div>
</body>
</html>`;
